...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-40 flex h-screen flex-col border-r border-gray-200/60 dark:border-slate-800 bg-gradient-to-b from-white via-gray-50/30 to-white dark:from-slate-900 dark:via-slate-900/95 dark:to-slate-900 shadow-xl transition-all duration-300 ease-in-out',
